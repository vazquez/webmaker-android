...
module.exports = '<a href="/app/{{url}}">\n    <div class="left">\n        <span class="name">{{name}}</span>\n        <span v-if="user" class="author">by {{user.name}}</span>\n    </div>\n\n    <div class="right">\n        <img class="app-icon" src="{{icon}}">\n        <img v-if="user" class="user-icon" src="{{user.avatar}}">\n    </div>\n</a>\n';
...
module.exports = '<a href="/app/{{url}}">{{name}} {{user.name}} {{user.location}}</a>';
...
},{"../views/apps":52,"../views/detail":54,"../views/profile":57,"../views/templates":60,"./router":11,"domready":13,"vue":42}],10:[function(require,module,exports){
/**
 * Data model provider.
 *
 * @package appmaker
...
},{"localforage":20,"watchjs":49}],11:[function(require,module,exports){
...
},{"./model":10,"page":21}],12:[function(require,module,exports){
...
},{"promise":15}],19:[function(require,module,exports){
// Exclude 'redefinition of {a}' from jshint as we are declaring a local var
// that appears to conflict with the global namespace.
// http://jslinterrors.com/redefinition-of-a
/*jshint -W079 */
...
},{"promise":15}],20:[function(require,module,exports){
/*jshint latedef:false */
...
},{"./drivers/indexeddb":17,"./drivers/localstorage":18,"./drivers/websql":19,"promise":15}],21:[function(require,module,exports){
...
module.exports={
    "created": [
        ...
        {
            "id": 1235,
            "url": "https://a.makes.org/lkjwewewedf",
            "name": "Living Doc",
            "icon": "http://placekitten.com/g/300/300",
            "description": "Lorem ipsum dolor sit amet"
        }
    ...
    "installed": [
        {
            "id": 1238,
            "url": "https://c.makes.org/lkjahsdf",
            "name": "Jaipur Tours",
            "icon": "http://placekitten.com/g/250/250",
            "description": "Lorem ipsum dolor sit amet",
            "user": {
                "name": "Sanjay",
                "avatar": "http://placekitten.com/g/251/251",
                "location": "India",
                "description": "A tour"
            }
        }
...
module.exports = '<div v-component="navigationBar"></div>\n<ul>\n    <lh>Apps I\'ve Created</lh>\n    <li v-component="appCell" v-repeat="created"></li>\n    <lh>Apps I\'ve Installed</lh>\n    <li v-component="appCell" v-repeat="installed"></li>\n</ul>\n<div v-component="tabBar"></div>\n';
...
},{"../../components/appCell":2,"../../components/navigationBar":6,"../../components/tabBar":8,"./data.json":50,"./index.html":51,"localforage":20}],53:[function(require,module,exports){
module.exports = '<div v-component="navigationBar"></div>\n<div v-component="tabBar"></div>';
...
},{"../../components/navigationBar":6,"../../components/tabBar":8,"./index.html":53}],55:[function(require,module,exports){
module.exports={
    "name": "Pedro",
    "location": "Brazil",
    "avatar": "http://www.fillmurray.com/g/300/300"
}

},{}],56:[function(require,module,exports){
module.exports = '<div v-component="navigationBar"></div>\n\n<div class="row">\n  <div class="left"></div>\n  <div class="right">\n  </div>\n</div>\n\n<div id="profile-header">\n  <div class="profile-avatar" style="background-image: url({{avatar}});"></div>\n  <div class="profile-info"><strong>{{name}}</strong> from <strong>{{location}}</strong></div>\n</div>\n\n<form id="profile-details">\n  <div class="form-group">\n    <label for="name">Name</label>\n    <input name="name" type="text" v-model="name">\n  </div>\n  <div class="form-group">\n    <label for="location">Location</label>\n    <input name="location" type="text" v-model="location">\n  </div>\n</form>\n<div v-component="tabBar"></div>\n';
...
},{"../../components/navigationBar":6,"../../components/tabBar":8,"./data.json":55,"./index.html":56}],58:[function(require,module,exports){
module.exports=[
    {
        "id": 1234,
        "url": "https://a.makes.org/lkjahsdf",
...
module.exports = '<div v-component="navigationBar"></div>\n<ul>\n    <li v-component="discoverCell" v-repeat="personas"></li>\n</ul>\n<div v-component="tabBar"></div>';
...
},{"../../components/discoverCell":4,"../../components/navigationBar":6,"../../components/tabBar":8,"./data.json":58,"./index.html":59}]},{},[9]);
